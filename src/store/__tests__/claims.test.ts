...
describe("DAO stacking cycle helpers", () => {
  ...
  it("should use configured cycle ranges to classify DAO staking cycles", () => {
    ...
    expect(getVersionByCycle("mia", 86)).toBe("daoV2");
    expect(getVersionByCycle("mia", 87)).toBeUndefined();
    ...
    expect(getVersionByCycle("nyc", 86)).toBe("daoV2");
    expect(getVersionByCycle("nyc", 87)).toBeUndefined();
